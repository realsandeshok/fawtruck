...
const TruckModels = ({ language }) => {
  ...
  return (
    <>
      {language === "en" ? (
        <section id="Models" className="py-12 px-[3rem] bg-white">
          <div className="container mx-auto">
            ...
            <p className="text-center text-black text-sm md:text-lg lg:text-xl leading-relaxed md:mb-8 lg:mb-8 px-0 md:px-24 lg:px-20">
              Automotive enterprise with the <br />largest sales volume in the world
            </p>

            {/* Truck Models Grid (Visible only on desktop and larger) */}
            <div className="hidden lg:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <section id="Models" className="py-12 px-[3rem] bg-white">
          <div className="container mx-auto">
            ...
            <p className="text-center text-black text-sm md:text-lg lg:text-xl leading-relaxed mb-4 md:mb-6 lg:mb-8 px-4 md:px-16 lg:px-20">
              شركة السيارات التي تمتلك  <br />أكبر حجم مبيعات في العالم
            </p>
